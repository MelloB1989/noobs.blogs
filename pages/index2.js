  ...
  <div className="container">
    <div className="row">
      <div className="col-8 mx-auto text-center">
        <h2 className="mb-3 text-capitalize">Noobs Learning | Blogs</h2>
      </div>
    </div>
  </div>
    ...
    <div className="row">
      <div className="col-lg-9">
        <div className="me-lg-4">
          ...
          {sample_blogs.map(({id, image_url, title, des, date}) => (
          <div className="col-md-6" data-aos="fade" key={id}>
              <article className="blog-post">
                ...
                <div className="pt-4">
                  ...
                  <h2 className="h4">
                    <Link className="text-black" href={`/blogs/${id}`}>
                      {title}
                    </Link>
                  </h2>
                  <p>
                ...
                <nav className="mb-md-50">
                  <ul className="pagination justify-content-center">
                    <li className="page-item active ">
                      {" "}
                      <a href="blog.html" className="page-link">
                        1
                      </a>
                    </li>
